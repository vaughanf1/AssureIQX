---
phase: 07-documentation-reports
plan: 01
type: execute
wave: 1
depends_on: []
...
6. **Performance Metrics** -- TWO tables (stratified and center-holdout):
...
grep -c "Model Details\|Intended Use\|Training Data\|Evaluation Data\|Performance\|Limitations\|Ethical\|Recommendations" docs/model_card.md
```
Should return 8 (all sections present).
...
5. **Results**:
   ...
   - **5.4 BTXRD Baseline Comparison**: Compare against YOLOv8s-cls results from the paper. Include ALL 7 caveats from `results/comparison_table.json`.
...
<output>
After completion, create `.planning/phases/07-documentation-reports/07-01-SUMMARY.md`
</output>
